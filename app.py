...
class App:
    ...
    def __init__(self, window=tk.Tk(), window_title="Camera Classifier"):
        ...
        self.status_label.pack(anchor=tk.SW, padx=10, pady=10)
        self.init_gui()
    ...
    def init_gui(self):
        ...
        self.add_class_button = tk.Button(self.window, text="Add Object", bg="#D0D0E9", width=50, command=self.add_object)
    ...
    def add_object(self):
            ...
            if class_name:
                ...
                class_button.pack(anchor=tk.CENTER, expand=True, after=self.add_class_button)
                ...
                if os.path.exists(folder):
                    for file in os.listdir(folder):
                        ...
                        if os.path.isfile(file_path):
                            # Close and release any resources related to the image files
